...
|<p align="left">- 멤버 CRUD<br/>- 이메일 인증<br/>- 북마크<br/>- 질문 투표<br/></p> |<p align="left">- 질문 CRUD<br/>- 답변 CRUD<br/>- 답변 투표, 채택 기능<br/>- 태그<br/>- 예외처리 로직<br/></p>|<p align="left">- Spring Security<br/>- JWT<br/>- AWS<br/><br/></p>|<p align="left">- 질문 CRUD<br/>- 답변 CRUD<br/>- 질문상세페이지 부가기능</br>(북마크, 좋아요 & 싫어요, 답변채택)</br>- 답변 정렬 필터<br/>- 메인페이지 질문 검색 (공동)<br/></p>|<p align="left">-메인페이지 구현<br/>(필터,정렬,조회)<br/>-마이페이지 구현</br>(조회, 수정)<br/>-유저페이지 구현</br>-페이지네이션</br>-질문 검색</br>(tag, body,<br/>user,answerCo)</br>-Nav(lfet)</br></p>|<p align="left">- Header 구현</br>- Question 페이지 구현</br>- EditPost 페이지 구현</br>- Users 페이지 구현</br>- 질문 RUD</br>- 답변 CRUD</br>- 댓글 CRUD</br>- util 함수 작성</br></p>
